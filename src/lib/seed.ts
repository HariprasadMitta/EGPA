...
export const SAMPLE_BUNDLES: UseCaseBundle[] = [
  makeBundle({
    ...
    owner: "Hariprasad Mitta (Customer Care Ops Lead)",
    ...
    riskComplianceDetails: {
      ...
      escalationOwner: "Hariprasad Mitta (Customer Care Ops Lead)",
      ...
      accountableOwner: "Hariprasad Mitta (Customer Care Ops Lead)",
